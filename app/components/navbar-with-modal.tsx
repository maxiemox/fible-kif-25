...
export default function NavbarWithModal() {
  ...
  return (
    <>
      <nav className="fixed top-0 w-full z-40 bg-black/90 backdrop-blur-sm border-b border-yellow-500/20">
      ...
      {/* Integration Modal */}
      <IntegrationModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </>
  )
}
