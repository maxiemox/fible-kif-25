...
export default function HeroSection() {
  ...
  const handleTryDemo = () => {
    // Also redirect to Scene Symphony app
    window.open("https://app--scene-symphony-706f27f3.base44.app", "_blank")
  }
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-8">
            ...
            >
              Launch Scene Symphony
              <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </button>

            <button
              onClick={handleTryDemo}
              className="border-2 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black font-semibold text-lg px-8 py-4 rounded-md transition-all group inline-flex items-center"
            >
